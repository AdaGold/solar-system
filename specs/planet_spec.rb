...
describe "Test Planet class" do
  ...
  xit "will raise ArgumentError for invalid mass and distance" do
    expect{planet = Planet.new("Name", "color", "99", "99", "Fun fact")}.must_be_silent
    expect{planet = Planet.new("Name", "color", 99, "99", "Fun fact")}.must_raise ArgumentError
    expect{planet = Planet.new("Name", "color", "99", 99, "Fun fact")}.must_raise ArgumentError
    expect{planet = Planet.new("Name", "color", "99", "99", "Fun fact")}.must_raise ArgumentError
    expect{planet = Planet.new("Name", "color", 99, 0, "Fun fact")}.must_raise ArgumentError
    expect{planet = Planet.new("Name", "color", 0, 99, "Fun fact")}.must_raise ArgumentError
